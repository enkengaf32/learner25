#This script will help us to perform arithmetic of any kind number
# it also ascept decimal numbers
#!/bin/bash
...
echo " This is awesome we just build our first calculator for group15 "
